  ...
  if ( ! class_exists( 'FLW_Rave_Shortcode' ) ) {
    ...
    class FLW_Rave_Shortcode {
      ...
      public function pay_button_shortcode( $attr, $content="" ) {
        ...
        if(empty(explode(",",$payment_forms->get_option_value('extra_field_1'))[0])){
          $extra_fields = [];
        }else{
        ...
        if(empty(explode(",",$payment_forms->get_option_value('extra_field_2'))[0])){
          $extra_fields_checkbox = [];
        }else{
          $extra_fields_checkbox = explode(",", $payment_forms->get_option_value('extra_field_2'));
          if(count($extra_fields_checkbox) == 1){
            $extra_fields_checkbox = $extra_fields_checkbox[0];
          }
        }
        ...
        $main_option_default = array(
          ...
          if(count($extra_fields_checkbox) != 0){
